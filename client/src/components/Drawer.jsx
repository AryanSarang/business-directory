                        ...
                        <ul className="space-y-2 font-medium">
                            <li>
                                <Link to={"/allconsultants/All"} onClick={toggleDrawer} className="flex mobileMenuLink items-center p-2 rounded-lg text-white hover:bg-gray-700 group">
                                    ...
                                    <span className="ml-3 whitespace-nowrap">Consultants</span>
                                </Link>
                            </li>
                            <li>
                                <Link to={"/agencies"} onClick={toggleDrawer} className="flex mobileMenuLink items-center p-2 rounded-lg text-white hover:bg-gray-700 group">
                                    <FaAddressCard className="flex-shrink-0 w-5 h-5 transition duration-75 text-gray-400 group-hover:text-white" />
                                    <span className="ml-3 whitespace-nowrap">Agencies</span>
                                </Link>
                            </li>
                            <li>
                            ...
                            <li>
                                ...
                                <ul id="dropdown-example" className={`${isDropdownOpen ? 'block' : 'hidden'} py-2 space-y-2`}>
                                    <li>
                                        <Link to={"/allconsultants/Performance Marketing"} onClick={toggleDrawer} className="flex mobileMenuLink items-center w-full p-2 text-white transition duration-75 rounded-lg pl-11 group hover:bg-slate-700">
                                            Performance Marketing
                                        </Link>
                                    </li>
                                    <li>
                                        <Link to={"/allconsultants/UI UX"} onClick={toggleDrawer} className="flex mobileMenuLink items-center w-full p-2 text-white transition duration-75 rounded-lg pl-11 group hover:bg-slate-700">
                                            UI UX
                                        </Link>
                                    </li>
                                    <li>
                                        <Link to={"/allconsultants/Brand Strategy"} onClick={toggleDrawer} className="flex mobileMenuLink items-center w-full p-2 text-white transition duration-75 rounded-lg pl-11 group hover:bg-slate-700">
                                            Brand Strategy
                                        </Link>
                                    </li>
                                    <li>
                                        <Link to={"/allconsultants/CRM"} onClick={toggleDrawer} className="flex mobileMenuLink items-center w-full p-2 text-white transition duration-75 rounded-lg pl-11 group hover:bg-slate-700">
                                            CRM
                                        </Link>
                                    </li>
